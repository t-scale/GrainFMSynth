...
* **0**: `/addfm/FM/harmonic_ratio`
* **1**: `/addfm/FM/freq`
* **2**: `/addfm/FM/mod_index`
* **3**: `/addfm/envelope/attack`
* **4**: `/addfm/envelope/decay`
* **5**: `/addfm/envelope/sustain`
* **6**: `/addfm/envelope/release`
* **7**: `/addfm/envelope/gain`
* **8**: `/addfm/envelope/gate`
